...
describe('groupValues', () => {
  ...
  it('should group orders by userId and orderId', () => {
    ...
    (formatDateToDB as jest.Mock).mockReturnValueOnce('2020-12-01');
    (formatDateToDB as jest.Mock).mockReturnValueOnce('2020-12-01');
  ...
  it('should group orders correctly with multiple users and orders', () => {
    ...
    (formatDateToDB as jest.Mock).mockReturnValueOnce('2020-12-01');
    (formatDateToDB as jest.Mock).mockReturnValueOnce('2020-12-02');
    (formatDateToDB as jest.Mock).mockReturnValueOnce('2020-12-03');
    (formatDateToDB as jest.Mock).mockReturnValueOnce('2020-12-04');
